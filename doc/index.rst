.. MAD-Toolkit documentation master file, created by
...
**Useful links**:
`Source Repository <https://github.com/scikit-learn-contrib/MAD-Toolkit>`__ |
`Issues & Ideas <https://github.com/scikit-learn-contrib/MAD-Toolkitk/issues>`__ |

This is the documentation for the `MAD-Toolkit` to help at extending
