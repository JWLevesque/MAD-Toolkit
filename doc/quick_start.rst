...
To create your package, you need to clone the ``MAD-Toolkit`` repository:

.. prompt:: bash $

  git clone https://github.com/scikit-learn-contrib/MAD-Toolkit.git

Before to reinitialize your git repository, you need to make the following
changes. Replace all occurrences of ``MAD-Toolkit``, ``MAD-Toolkit``, or
``MAD-Toolkit`` with the name of you own project. You can find all the
occurrences using the following command:

.. prompt:: bash $

  git grep MAD-Toolkit
  git grep MAD-Toolkit
  git grep MAD-Toolkit
